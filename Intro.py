...
# --- SIDEBAR ---
with st.sidebar:
    st.image("images/71xHh6f9YgL._AC_UF1000,1000_QL80_.jpg", caption="Finn y Jake en acción", use_container_width=True)
...
with col1:
    st.subheader("🚀 Intro")
    st.image("images/l-intro-1617997359.jpg", width=220)
    ...
    st.image("images/adventure-time-cake-the-cat.png", width=220)
...
with col3:
    ...
    st.image("images/is-it-me-or-does-marceline-look-different-as-the-series-v0-wmaumw5d3uh3b1.jpg", width=220)
    st.markdown("[Ver app 📄](https://xa5vblnqwqtfegqumkrlsk.streamlit.app/)")

    st.subheader("🤲 Reconocimiento de Gestos (Teachable Machine)")
    st.image("images/da19b91522a87825e03d47f903838e66.jpg", width=220)
    st.markdown("[Ver app ✋](https://recongestos-qulswrztg3uqi9wjyz7r3w.streamlit.app/)")

    st.subheader("💖 Análisis de Sentimiento")
    st.image("images/ Screenshot-2023-06-08-144133.jpg".replace(" ",""), width=220)
    st.markdown("[Ver app 💌](https://icr9cbjgn9ntpknmvorubn.streamlit.app/)")

    st.subheader("🗣️ Traductor Voz - Texto")
    st.image("images/marceline-is-best-adventure-time-character-v0-wykgmlp7pvzd1.webp".replace("webp","jpg"), width=220)
